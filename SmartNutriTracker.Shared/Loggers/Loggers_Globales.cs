...
namespace SmartNutriTracker.Shared.Loggers
{
    public static class Loggers_Globales
    {
        ...
        //NOTIFICACION DIARIA - LOGS DE OPERACIONES
        public const string LOG_NOTIFICACION_DIARIA_OBTENER_PENDIENTES_INICIO = "Info, Iniciando obtención de notificaciones diarias pendientes";
        public const string LOG_NOTIFICACION_DIARIA_CONSULTA_BD = "Info, Ejecutando consulta de estudiantes sin registro del día";
        public const string LOG_NOTIFICACION_DIARIA_OBTENER_PENDIENTES_EXITOSO = "Success, Notificaciones diarias obtenidas exitosamente";
        public const string LOG_NOTIFICACION_DIARIA_OBTENER_PENDIENTES_ERROR = "Error, Error al obtener notificaciones diarias pendientes";

        public const string LOG_NOTIFICACION_DIARIA_OBTENER_POR_ESTUDIANTE_INICIO = "Info, Solicitando notificación diaria para estudiante específico";
        public const string LOG_NOTIFICACION_DIARIA_ESTUDIANTE_ID_RECIBIDO = "Info, Parámetro estudianteId recibido para notificación";
        public const string LOG_NOTIFICACION_DIARIA_OBTENER_POR_ESTUDIANTE_ENCONTRADO = "Success, Notificación diaria encontrada para estudiante";
        public const string LOG_NOTIFICACION_DIARIA_OBTENER_POR_ESTUDIANTE_NO_ENCONTRADO = "Warning, Estudiante no requiere notificación o no existe";
        public const string LOG_NOTIFICACION_DIARIA_OBTENER_POR_ESTUDIANTE_ERROR = "Error, Error al obtener notificación diaria por estudiante";

        //NOTIFICACION LIMITE - LOGS DE OPERACIONES
        public const string LOG_NOTIFICACION_LIMITE_OBTENER_ALERTAS_INICIO = "Info, Iniciando proceso de detección de riesgos nutricionales";
        public const string LOG_NOTIFICACION_LIMITE_CONSULTA_BD = "Info, Ejecutando análisis de límites calóricos por estudiante";
        public const string LOG_NOTIFICACION_LIMITE_CALCULO_EXCESOS = "Info, Calculando excesos calóricos respecto a límites recomendados";
        public const string LOG_NOTIFICACION_LIMITE_OBTENER_ALERTAS_EXITOSO = "Success, Alertas nutricionales generadas correctamente";
        public const string LOG_NOTIFICACION_LIMITE_SIN_ALERTAS = "Info, No se encontraron estudiantes con exceso calórico";
        public const string LOG_NOTIFICACION_LIMITE_OBTENER_ALERTAS_ERROR = "Error, Error al generar alertas de límite calórico";

        //TESTING - LOGS DE OPERACIONES
        public const string LOG_TESTEO_BD = "Success, Si ves esto es pq funciona bien";
        public const string LOG_TESTEO_CONEXION_INICIO = "Info, Iniciando prueba de conexión a base de datos";
        public const string LOG_TESTEO_CONEXION_EXITOSO = "Success, Conexión a base de datos establecida correctamente";
        public const string LOG_TESTEO_CONEXION_ERROR = "Error, Fallo en la conexión a base de datos";
        public const string LOG_TESTEO_ENDPOINT_INICIO = "Info, Iniciando prueba de endpoint";
        public const string LOG_TESTEO_ENDPOINT_EXITOSO = "Success, Endpoint respondió correctamente";
        public const string LOG_TESTEO_ENDPOINT_ERROR = "Error, Endpoint no respondió o falló";
        public const string LOG_TESTEO_SERVICIO_INICIO = "Info, Iniciando prueba de servicio interno";
        public const string LOG_TESTEO_SERVICIO_EXITOSO = "Success, Servicio interno funcionando correctamente";
        public const string LOG_TESTEO_SERVICIO_ERROR = "Error, Fallo en servicio interno";

        //NOTIFICACION DIARIA - VALIDACIONES
        public const string VAL_NOTIFICACION_DIARIA_ESTUDIANTE_ID_INVALIDO = "Error, Validación fallida: El EstudianteId de la notificación no es válido o no existe";
        public const string VAL_NOTIFICACION_DIARIA_ESTUDIANTE_ID_VACIO = "Error, Validación fallida: El EstudianteId es requerido para la notificación";
        public const string VAL_NOTIFICACION_DIARIA_NOMBRE_ESTUDIANTE_VACIO = "Error, Validación fallida: El nombre del estudiante no puede estar vacío";
        public const string VAL_NOTIFICACION_DIARIA_NOMBRE_ESTUDIANTE_LONGITUD = "Error, Validación fallida: El nombre del estudiante excede la longitud permitida";
        public const string VAL_NOTIFICACION_DIARIA_MENSAJE_VACIO = "Error, Validación fallida: El mensaje de la notificación no puede estar vacío";
        public const string VAL_NOTIFICACION_DIARIA_MENSAJE_LONGITUD = "Error, Validación fallida: El mensaje de la notificación excede la longitud permitida";
        public const string VAL_NOTIFICACION_DIARIA_FECHA_INTENTO_INVALIDA = "Error, Validación fallida: La fecha de intento no es válida";
        public const string VAL_NOTIFICACION_DIARIA_FECHA_INTENTO_FUTURA = "Error, Validación fallida: La fecha de intento no puede ser futura";
        public const string VAL_NOTIFICACION_DIARIA_OBJETO_NULO = "Error, Validación fallida: El objeto NotificacionDiaria no puede ser nulo";
        public const string VAL_NOTIFICACION_DIARIA_ESTUDIANTE_NO_ENCONTRADO = "Warning, Validación fallida: El estudiante especificado no existe en el sistema";
        public const string VAL_NOTIFICACION_DIARIA_YA_REGISTRADO = "Warning, Validación fallida: El estudiante ya tiene un registro para hoy";

        //NOTIFICACION LIMITE - VALIDACIONES
        public const string VAL_NOTIFICACION_LIMITE_ESTUDIANTE_ID_INVALIDO = "Error, Validación fallida: El EstudianteId de la alerta no es válido o no existe";
        public const string VAL_NOTIFICACION_LIMITE_ESTUDIANTE_ID_VACIO = "Error, Validación fallida: El EstudianteId es requerido para la alerta";
        public const string VAL_NOTIFICACION_LIMITE_NOMBRE_ESTUDIANTE_VACIO = "Error, Validación fallida: El nombre del estudiante no puede estar vacío en la alerta";
        public const string VAL_NOTIFICACION_LIMITE_LIMITE_CALORICO_INVALIDO = "Error, Validación fallida: El límite calórico no es válido o está fuera de rango";
        public const string VAL_NOTIFICACION_LIMITE_LIMITE_CALORICO_NEGATIVO = "Error, Validación fallida: El límite calórico no puede ser negativo o cero";
        public const string VAL_NOTIFICACION_LIMITE_CALORIAS_CONSUMIDAS_INVALIDAS = "Error, Validación fallida: Las calorías consumidas no son válidas";
        public const string VAL_NOTIFICACION_LIMITE_CALORIAS_CONSUMIDAS_NEGATIVAS = "Error, Validación fallida: Las calorías consumidas no pueden ser negativas";
        public const string VAL_NOTIFICACION_LIMITE_EXCESO_INVALIDO = "Error, Validación fallida: El valor de exceso calórico no es válido";
        public const string VAL_NOTIFICACION_LIMITE_EXCESO_NEGATIVO = "Error, Validación fallida: El exceso no puede ser negativo";
        public const string VAL_NOTIFICACION_LIMITE_MENSAJE_VACIO = "Error, Validación fallida: El mensaje de alerta no puede estar vacío";
        public const string VAL_NOTIFICACION_LIMITE_MENSAJE_LONGITUD = "Error, Validación fallida: El mensaje de alerta excede la longitud permitida";
        public const string VAL_NOTIFICACION_LIMITE_OBJETO_NULO = "Error, Validación fallida: El objeto AlertaNutricional no puede ser nulo";
        public const string VAL_NOTIFICACION_LIMITE_EXCESO_INCONSISTENTE = "Warning, Validación fallida: El exceso calculado no coincide con la diferencia entre consumo y límite";
        public const string VAL_NOTIFICACION_LIMITE_SIN_DATOS_NUTRICIONALES = "Warning, Validación fallida: El estudiante no tiene datos nutricionales configurados";
